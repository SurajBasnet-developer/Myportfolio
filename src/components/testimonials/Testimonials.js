...
const Testimonials = () => {
  const testimonials = [
    ...
    },
    {
      ...
      test: "It was a pleasure collaborating with Suraj on different projects. One of the things that I think is special about her is that He never settles, even after completing the projects He finds other resources and strengthens her knowledge. Collaborating with her is easy and comfortable, it's like working with someone you've known for a long period of time.",
    },
    {
      id: 3,
      ...
      test: "I worked with Suraj in the same team and her communication skills are very strong. Her programming skill is one of the bests, given the time frame in the field. He is a good team player.  He will probably fit in most of the companies not only because He's a good team worker, but also because He has very good skills and I know He has much more potential to be shown.",
    },
    {
      id: 4,
